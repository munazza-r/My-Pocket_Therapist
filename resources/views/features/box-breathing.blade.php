...
<div class="header">
    ...
    <div class="main-content">
        ...
        <div class="steps-container">
            <div class="step-card">1. Breathe in, counting to four slowly. Feel the air enter your lungs.</div>
            <div class="step-card">2. Hold your breath for 4 seconds. Try to avoid inhaling or exhaling for 4 seconds.</div>
            <div class="step-card">3. Slowly exhale through your mouth for 4 seconds.</div>
            <div class="step-card">4. Wait for another 4 seconds before you breathe in again.</div>
            <div class="step-card">5. Continue this pattern for a few minutes or as long as you feel comfortable.</div>
        </div>
