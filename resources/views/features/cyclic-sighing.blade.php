...
<div class="header">
    ...
    <div class="main-content">
        <div class="page-header">
            <h1>Cyclic Sighing</h1>
        </div>

        <div class="steps-container">
            <div class="step-card">1. Set a timer for 5 minutes.</div>
            <div class="step-card">2. Take a deep breath and fill your lungs completely.</div>
            <div class="step-card">3. Take another shorter breath filling your lungs to capacity. It will be shorter than your first inhale.</div>
            <div class="step-card">4. Release this breath through your nose.</div>
            <div class="step-card">5. Repeat this process for the duration of the five minutes.</div>
        </div>
